...
public class Personne {
    ...
    public String toStringDetails() {
        return "ID : " + ID + " - Matricule: "+ matricule + " - Prenom & Nom: " + prenom +" "+ nom + " - Adresse:" + adresse + "\n - Date De Naissance:" + date_de_naissance + " - Telephone:" + telephone + " - email: " + email + " - Situation Matrimoniale: " + situation_matrimoniale;
    }
